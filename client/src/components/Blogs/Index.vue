<template>
  <div v-if="isUserLoggedIn && user.type == 'admin'">
    ...
    <div class="header">
      <h3><i class="fas fa-th-list"></i> รายการคลังอุปกรณ์</h3>
    </div>
    <div class="container">
      <div class="blog-header">
        <div class="create-blog" style="width: 100%">
                  ...
                  <span class="badge badge-primary" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>จำนวนผู้ใช้ {{ users.length }} คน</h4>
                      </div>
                    </div>
                  </span>
                </td>
                <td width="30%" align="center">
                  <span class="badge badge-success" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>จำนวนอุปกรณ์ {{ results.length }} ชิ้น</h4>
                      </div>
                    </div>
                  </span>
                </td>
                <td width="30%" align="center">
                  <span class="badge badge-danger" style="padding: 10px">
                    <div class="media" style="margin-top: 10px">
                      ...
                      <div class="media-body" style="text-indent: 1em">
                        <h4>การทำรายการยืม {{ borrows.length }} รายการ</h4>
                      </div>
                    </div>
                  </span>
                </td>
          ...
          <form class="form-inline form-search">
            ...
            <div class="input-group mb-3" style="width: 30%">
              <input
                ...
                placeholder="ค้นหาอุปกรณ์, หมวดหมู่, สถานะ"
          ...
          >
            <i class="fas fa-plus-circle"></i> เพิ่มอุปกรณ์ & พัสดุ
          </button>
        </div>
        <br />
      ...
      <transition-group name="fade">
        <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
          ...
          <div class="blog-info">
            <p>
              <span class="font2">รหัสพัสดุ:</span> {{ blog.id }}<br />
              <span class="font2">หมวดหมู่:</span> {{ blog.category }}<br />
              <span class="font2">สถานะ:</span> {{ blog.status }}<br />
              <span class="font2">วันที่สร้าง:</span>

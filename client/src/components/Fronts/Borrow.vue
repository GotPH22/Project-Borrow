<template>
  <div>
    ...
    <div class="header">
      <h3><i class="fas fa-box"></i> ทำรายการยืม</h3>
    </div>
    <div class="container-fluid">
      <div class="container">
        <div class="blog-wrapper">
          <h4><i class="far fa-clipboard"></i> รายละเอียดการทำรายการ</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBorrow">
              ...
              >
                <div class="blog-tab"><h5>รายละเอียดการยืม</h5></div>
                <p class="font3" style="margin-top: 10px">
                  {{ borrow.equipment }} จำนวน: {{ borrow.number }} วันที่ยืม:
                  {{ borrow.dateLend }} กำหนดคืน:
                  {{ borrow.dateReturn }}
                </p>
              </div>
              <div class="row">

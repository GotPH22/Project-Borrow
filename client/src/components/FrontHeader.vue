    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <router-link class="navbar-brand" active-class="active" to="/front">
        <img
          ...
          loading="lazy"
        />
        <span class="font1">&nbsp;ระบบยืม-คืน พัสดุและครุภัณฑ์</span>
      </router-link>
      <button
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link class="nav-link" active-class="active" to="/treasury"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-boxes"></i> คลังอุปกรณ์</span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/create"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-clipboard-list"></i> ทำรายการยืม</span
              ></router-link
            >
          </li>
          <li class="nav-item active" v-if="isUserLoggedIn">
            <router-link
              ...
              to="/borrow/status"
              ><span class="font2" style="color: #fff"
                ><i class="fas fa-list-ul"></i> สถานะยืม & คืน</span
              ></router-link
            >
          </li>
          ...
          <div class="dropdown">
            ...
            >
              <a
                ...
                ><i class="fas fa-home"></i> ระบบหลังบ้าน</a
              >
              <a
                class="dropdown-item"
                href=""
